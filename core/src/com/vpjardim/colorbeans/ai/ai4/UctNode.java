...
public class UctNode implements Pool.Poolable, DebugNode {
    ...
    public UctNode expand() {
        ...
        // Level 1 is the root (current state) which children (next state) has known
        // colors blocks
    ...
    public UctNode bestChild() {
        ...
        // #debugCode
        if (children.size < 1)
            throw new UnsupportedOperationException("Should have at least 1 child");
        ...
        for (int i = 0; i < children.size; i++) {
            ...
            // Sum Uct.EPSILON to avoid zero division as this number will be used as a
            // divisor
    ...
    public boolean isTerminal() {
        ...
        // based on a 7x15 map. But the adversary could lose with less (or need more)
        // trash block. So this need to be update while opponents change it's state.
        // Obs: negative values are illegal moves or lost moves, so they are also
        // terminal states
