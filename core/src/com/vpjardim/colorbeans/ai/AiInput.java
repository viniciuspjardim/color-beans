...
public class AiInput implements InputBase {
    ...
    @Override
    public int getId() { throw new UnsupportedOperationException("Ai Input does not have an id"); }
    ...
    public void move() {
        ...
        // If there is no horizontal move and no rotation to be done, the down key can be pressed
     ...
     *
     * @param hMove horizontal move: column of where the left most player block should be on the map
